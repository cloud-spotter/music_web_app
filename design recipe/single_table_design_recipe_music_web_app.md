...
The test should assert that the new album is present in the list of albums returned by GET /albums.
Create album table with columns title, release year and artist.
